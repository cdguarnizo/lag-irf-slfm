% E_LTI_SDE Negative log marginal likelihood of LTI SDEs
% 
% Syntax:
%  E = E_lti_sde(theta,param)
%
% In:
...
%
% Description: 
%  Calculates the negative log marginal likelihood of LTI SDEs
%  of the form
%  
...
function E = E_lti_sde(theta,param)
    ...
    for k = 1:steps
        ...
        if mind(k) == 1,
            ...
            [M,P,K,IM,S]= kf_update(M,P,Yt,Ht,Rt);
